...
var compose = function(){
  ...
  return function() {
    ...
    for (var i=funcs.length-1; i>=0; i--) {
      if (i===funcs.length-1) {
        currentArgs = funcs[i].apply(null, currentArgs);
      } else {
        currentArgs = funcs[i].call(null, currentArgs);
      }
    }
    return currentArgs;
  };
...
var pipe = function(){
  return compose.apply(this, Array.prototype.slice.call(arguments).reverse());
};
